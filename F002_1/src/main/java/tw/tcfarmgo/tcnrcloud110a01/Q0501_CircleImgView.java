...
public class Q0501_CircleImgView extends androidx.appcompat.widget.AppCompatImageView {
    private Paint paint = new Paint();

    public Q0501_CircleImgView(Context context) {
        super(context);
    }

    public Q0501_CircleImgView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Q0501_CircleImgView(Context context, AttributeSet attrs, int defStyleAttr) {
